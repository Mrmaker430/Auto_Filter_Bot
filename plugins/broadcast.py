...
from utils import broadcast_messages, groups_broadcast_messages, temp, get_readable_time, clear_junk, junk_group
...
async def junk_clear_group(bot, message):
    ...
    try:
        ...
        logger.error("Error sending junk group report: %s", e)
