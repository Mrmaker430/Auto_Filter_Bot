...
<b>🍁 ʙʏ : <a href="https://t.me/cholochhitro">[ ᴄʜᴏʟᴏᴄʜʜɪᴛʀᴏ ]</a></b>"""
    ...
    MOVIE_UPDATE_NOTIFY_TXT = """<b>🔥 𝖭𝖤𝖶 𝖥𝖨𝖫𝖤 𝖠𝖣𝖣𝖤𝖣 🔥</b>

<blockquote expandable>🏷️ <b>𝖳𝗂𝗍𝗅𝖾</b> : <a href="{imdb_url}"><b>{filename}</b></a>
🎭 <b>𝖦𝖾𝗇𝗋𝖾𝗌</b> : {genres}
📡 <b>𝖮𝗍𝗍</b> : {ott}
⏩ <b>𝖰𝗎𝖺𝗅𝗂𝗍𝗒</b> : {quality}
☀️ <b>𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾𝗌</b> : {language}
🌟 <b>𝖱𝖺𝗍𝗂𝗇𝗀</b> : {rating}
{episodes}</blockquote>"""
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @cholochhitrosupport
...
ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://github.com/>𝑲𝒉𝒐𝒌𝒂𝒃𝒂𝒃𝒖 (𝒓𝒆𝒒) ⁿᵒ ᵃᵈˢ</a>\n """
...
• /msg - <code>ꜱᴇɴᴅ ᴘᴇʀꜱᴏɴᴀʟ ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ ᴀ ꜱᴘᴇᴄɪꜰɪᴄ ᴜꜱᴇʀ.</code>
